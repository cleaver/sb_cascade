...
#
#     PHX_SERVER=true bin/sb_cascade start
#
...
if config_env() == :prod do
  ...
  config :sb_cascade, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  host_name = System.get_env("PHX_HOST_NAME")

  origins =
    if allow_local do
      ["http://localhost:4000", "http://127.0.0.1:4000", host_name]
    else
      [host_name]
    end
  ...
  #
  #     config :sb_cascade, SbCascade.Mailer,
